...
SMS_TAKEN_MEDICATION_TEXT = "Hello, this is Pill-ar, your AI-powered medical assistant. {patient_name} has successfully drop their scheduled medication today at {schedule_time}. Medication drop: {pill}. Thank you for trusting Pill-ar!"
SMS_NOT_TAKEN_MEDICATION_TEXT = "Hello, this is Pill-ar, your AI-powered medical assistant. {patient_name} has not drop their scheduled medication today at {schedule_time}. Thank you for trusting Pill-ar!"
SMS_MAYBE_TAKEN_OR_NOT_NEED_TO_VERIFY_TEXT = "Hello, this is Pill-ar, your AI-powered medical assistant. {patient_name}'s scheduled medication at {schedule_time} may or may not have been taken. Medication in question: {pill}. Please check to confirm. Thank you for trusting Pill-ar in your health care journey!"
